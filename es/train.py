...
from gaussian_renderer import render_es
import sys
...
def training(dataset, opt, pipe, testing_iterations, saving_iterations, checkpoint_iterations, checkpoint, debug_from, args):
    ...
    for iteration in range(first_iter, opt.iterations + 1):        
        ...
        render_pkg = render_es(viewpoint_cam, gaussians, pipe, background)
        ...
        with torch.no_grad():
            ...
            if iteration < opt.densify_until_iter:
                ...
                if iteration%5000==0:
                    ...
                    for view in views:
                        ...
                        render_depth_pkg = render_es(view, gaussians, pipe, background)
            ...
            if iteration == simp_iteration1:
                ...
                for view in views:
                    # print(idx)
                    render_pkg = render_es(view, gaussians, pipe, background)
